...
{ 
    ...
    // auto h_W1_flavor = m_histContainer->get1DHist("h_W1_flavor", 4, 0, 4);
    // auto h_W2_flavor = m_histContainer->get1DHist("h_W2_flavor", 4, 0, 4);
    ...
    for(int i = 0; i < nEntries; i++)
    {
        ...
        if (truthJets_Wm.size() >= 2 && truthJets_Wp.size() >= 2) {
            ...
            h_W1_mass->Fill(W1_truthJet.M());
            h_W2_mass->Fill(W2_truthJet.M());

            h_W1_p->Fill(W1_truthJet.P());
            h_W2_p->Fill(W2_truthJet.P());

            CosPhi_Angle(W1_jet1, W1_jet2, h_cos_phi_truth_cs);
            CosPhi_Angle(W2_jet1, W2_jet2, h_cos_phi_truth_ud);
        }

        // if (W1_is_cs) h_W1_flavor->Fill(0);  // cs
        // else if (W1_is_ud) h_W1_flavor->Fill(1); // ud
        // else h_W1_flavor->Fill(3);  // something else

        // if (W2_is_cs) h_W2_flavor->Fill(0);
        // else if (W2_is_ud) h_W2_flavor->Fill(1);
        // else h_W2_flavor->Fill(3);
